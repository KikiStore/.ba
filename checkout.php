...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $total = $_POST['total']; // Asegúrate de calcular el total correctamente en el formulario

    $stmt = $conn->prepare("INSERT INTO orders (first_name, last_name, country, address, city, state, postcode, phone, email, order_notes, total) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssssssssd", $first_name, $last_name, $country, $address, $city, $state, $postcode, $phone, $email, $order_notes, $total);
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <input type="hidden" name="total" value="750.99">
                                <div class="checkout__input__checkbox">
                                    <label for="acc-or">
                                        Create an account?
